...
{
    id: 'p3',
    name: 'Uber & Lyft Cab Prices Prediction',
    type: 'Machine Learning',
    glyph: 'III',
    gradient: 'linear-gradient(135deg, #C8502A 0%, #2c1810 100%)',
    poster: '/images/ml_poster.png',
    tech: ['Python', 'scikit-learn', 'pandas'],
    github: 'https://github.com/AaronPerkey/Uber-and-Lyft-Cab-Prices-Prediction',
    desc: 'A machine learning project that predicts rideshare fares from real ride data. Compares linear regression against K-nearest neighbors, finding that fares follow local, non-linear patterns KNN captures best. Findings are found in through the github link.',
    media: '/images/ml_graphic.png',
    stack: [
      { role: 'Language', tags: ['Python'] },
      { role: 'ML & Data', tags: ['scikit-learn', 'pandas', 'NumPy'] },
    ],
  },
];
